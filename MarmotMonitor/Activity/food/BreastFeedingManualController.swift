//
//  BreastFeedingManualController.swift
//  MarmotMonitor
//
...
class BreastFeedingManualController: UIViewController {
    ...
    private func setupViews() {
        ...
        [timeLabel, timePicker, separator, stackView, rightPicker, leftPicker].forEach {
    ...
    private func setupContraints() {
        [timeLabel, timePicker, separator, stackView,
         rightPicker, leftPicker, totalTimeBreastLabel,
        ...
        NSLayoutConstraint.activate([
            ...
            leftPicker.bottomAnchor.constraint(equalTo: scrollArea.bottomAnchor, constant: -30)
        ])
    }
...
extension BreastFeedingManualController: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension BreastFeedingManualController: UIPickerViewAccessibilityDelegate {
